...
Série	ESOFT2SMB
Ano	2026
Temas trabalhados	Vacinação e Saúde Bucal
...
├── docs/     # Documentação da AEP (documento escrito, fluxogramas, pseudocódigos)
├── src/      # Código-fonte em C (implementado na Etapa 2)
└── README.md
👥 Integrantes
...
Nesta etapa, foram desenvolvidos a contextualização do problema, questão norteadora, objetivos, justificativa, definição dos usuários, escopo, requisitos, fluxogramas, pseudocódigos, riscos e planejamento das sprints.

A implementação completa do sistema em linguagem C será realizada na etapa seguinte da AEP.
